...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <br>**Para LFI path traversal:**<br><pre><code>`/usr/share/wordlists/seclists/Fuzzing/LFI/LFI-Jhaddix.txt`</code></pre>                                                                                                                                              |
| <br>**Para LFI web root:**<br><pre><code>`/usr/share/wordlists/seclists/Discovery/Web-Content/default-web-root-directory-linux.txt`</code></pre><pre><code>`/usr/share/wordlists/seclists/Discovery/Web-Content/default-web-root-directory-windows.txt`</code></pre> |
