...
| --------------------- | ------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------ |
| <br>**Linux (Bash)**  | <br>**Variable Slicing** (Extracción) | <pre><code>${PATH:0:1}</code></pre>        | <br>Extrae el carácter `/` que suele estar al inicio de la variable `$PATH` .                    |
| <br>**Linux**         | <br>**Variable Slicing** (Semicolon)  | <pre><code>${LS_COLORS:10:1}</code></pre>  | <br>Genera un punto y coma `;`. Útil para encadenar comandos inyectados.                         |
