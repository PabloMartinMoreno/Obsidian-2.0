...
| ------------------------------------ | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| <br>Upload directo + LFI             | <br>Subir un .php y luego incluirlo con el LFI                                                  | <br>Upload: `shell.php` → LFI: `/var/www/uploads/shell.php`<br><br>                       |
| <br>Extensión doble                  | <br>Evadir filtro de extensión usando doble extensión                                           | <br>Upload: `shell.php.jpg` → LFI al archivo subido<br><br>                               |
