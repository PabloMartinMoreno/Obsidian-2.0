...
| --------------------------------- | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------- |
| <br>Phar básico                   | <br>Crear un archivo PHAR con metadata serializada maliciosa y accederlo via `phar://`<br><br>         | <br>`phar:///var/www/uploads/evil.phar`<br><br>                                           |
...
| <br>Phar con polyglot GIF         | <br>Lo mismo pero con formato GIF usando magic bytes `GIF89a`                                          | <br>`GIF89a` + stub PHAR + metadata maliciosa<br><br>                                     |
